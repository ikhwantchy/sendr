...
function CreateReminderContent() {
            ...
            <div className="flex items-center justify-center min-h-screen bg-[#09090b] text-zinc-400">
                <div className="flex flex-col items-center gap-4 text-center max-w-md">
                    ...
                    <p className="text-zinc-500">
                        You don't have permission to create reminders on any bots.
    ...
    if (!selectedBotId && !editId) {
        return (
            <div className="flex items-center justify-center min-h-screen bg-[#09090b]">
                <div className="w-full max-w-md p-6">
                    <div className="text-center mb-8">
                        <h1 className="text-2xl font-bold text-white mb-2">Create Reminder</h1>
                        <p className="text-zinc-500">Select a bot to create a reminder for</p>
                    </div>
...
export default function UserCreateReminderPage() {
    return (
        <Suspense fallback={
            <div className="flex items-center justify-center min-h-screen bg-[#09090b]">
                <Loader2 className="w-8 h-8 animate-spin text-zinc-400" />
