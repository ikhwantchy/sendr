    ...
    if (!rules || rules.length === 0) {
        return (
            <div className="flex flex-col gap-4">
                ...
                <div className="flex justify-end">
                    <button
                        onClick={() => router.push(`/dashboard/rules/create?bot=${botId}`)}
                ...
                <div className="text-center py-24 sm:py-48 bg-zinc-900/30 border border-dashed border-zinc-800/50 rounded-2xl min-h-[400px] sm:min-h-[600px] flex flex-col items-center justify-center">
                    <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 bg-zinc-800/50 rounded-2xl sm:rounded-3xl mb-4 sm:mb-6 shadow-xl border border-zinc-700/50">
                        <Zap className="w-8 h-8 sm:w-10 sm:h-10 text-zinc-500" />
                    </div>
                    <h3 className="text-lg sm:text-xl font-bold text-zinc-100 mb-2 sm:mb-3">No Rules Yet</h3>
                    <p className="text-zinc-400 text-xs sm:text-sm max-w-xs mx-auto leading-relaxed px-4">Create your first auto-reply rule to automate your customer communication.</p>
                </div>
            </div>
        )
    }
