        ...
        <div className="p-8 min-h-screen bg-[#09090b] text-zinc-100">
            ...
            {reminders.length === 0 ? (
                <div className="bg-[#18181b] border border-zinc-800 rounded-xl p-12 text-center">
                    ...
                    <p className="text-zinc-500 text-sm mb-6">Create your first reminder to get started</p>
                    <button
                        onClick={() => router.push('/dashboard/reminders/create')}
                    ...
                    {reminders.map((reminder) => (
                        ...
                        >
                            ...
                            <div className="flex items-start justify-between mb-4">
                                <div className="flex-1">
                                    ...
                                    {reminder.description && (
                                        <p className="text-zinc-500 text-sm">{reminder.description}</p>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-3 mb-4">
                                <div className="bg-[#0d0d0f] border border-zinc-800 rounded-lg p-3">
                            ...
                            {/* Execution Info */}
                            <div className="bg-[#0d0d0f] border border-zinc-800 rounded-lg p-3 mb-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <span className="text-xs text-zinc-500 block mb-1">Last Run</span>
                                    ...
                                    <div>
                                        <span className="text-xs text-zinc-500 block mb-1">Next Run</span>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <button
                                    ...
                                    className="px-3 py-2 bg-zinc-800 text-zinc-300 hover:bg-zinc-700 rounded-lg transition-colors"
                                    title="Edit"
                                >
