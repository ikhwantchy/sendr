...
-- Copy-paste this entire file into your SQLite database tool
...
SELECT name FROM sqlite_master WHERE type='table' AND name IN ('api_keys', 'audit_logs', 'user_invites', 'system_settings', 'system_backups', 'message_analytics') ORDER BY name;

SELECT 'Settings count:' as status;
